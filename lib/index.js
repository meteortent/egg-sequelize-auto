  ...
  run(callback) {
    ...
    function generateText(err) {
      ...
      async.each(_.keys(self.tables), function(table, _callback) {
        ...
        var tsTableDef = self.options.typescript ? 'export class ' + tableName + 'Attribute extends Sequelize.Model {' : '';
        ...
        _.each(fields, function(field, i) {
          ...
          _.each(fieldAttr, function(attr, x) {
            ...
            if (attr === "foreignKey") {
              ...
              var val = quoteWrapper + (self.tables[table][field][attr]?self.tables[table][field][attr]:'') + quoteWrapper;
              ...
              if(self.options.typescript && attr === "type") tsVal = val;
            }
